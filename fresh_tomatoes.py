...
<head>
    ...
    <script type="text/javascript" charset="utf-8">
        ...
        // Start playing the video whenever the trailer modal image is clicked
...
<div class="col-md-6 col-lg-4 movie-tile text-center" data-trailer-youtube-id="{trailer_youtube_id}">
    <img src="{poster_image_url}" width="220" height="342" data-toggle="modal" data-target="#trailer">
    <h2>{movie_title}</h2>
    <p>{movie_storyline}</p>
    <p><a href="{movie_details}" target="blank">... more details</a></p>
</div>
'''  # noqa
